...
export default class myParserLexer extends antlr4.Lexer {
	...
	static ruleNames = [ "T__0", "ID", "WHITESPACE" ];
...
myParserLexer.EOF = antlr4.Token.EOF;
myParserLexer.T__0 = 1;
myParserLexer.ID = 2;
myParserLexer.WHITESPACE = 3;
